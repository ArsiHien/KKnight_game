//#include "Enemy.h"
//
//Monster::Monster(const int &xp, const int &yp, SDL_Texture *p_texture)
//{
//    mTexture = p_texture;
//    HP = 150;
//    on_ground = false;
...
//}
//
//void Monster::move(const SDL_Rect &player_box, Tile* map_data)
//{
//    mVelX = 0;
...
//}
//
//void Monster::isAttacked(const Input &input, const SDL_Rect &player_box, const SDL_Rect &player_currentBox, const int &player_status)
//{
...
//}
//
//bool Monster::isAttacking(const Input &input, SDL_Rect player_box)
//{
//    if(thinkTime > 0)
//    {
//        thinkTime--;
...
//{
////    darkWarriors.push_back(Monster(500, 100, p_texture));
//}
//
